...
type Repository interface {
	...
	GetPublishedBySlug(ctx context.Context, slug string) (*Blog, error)
	GetAll(ctx context.Context) ([]*Blog, error)
	List(ctx context.Context, filter BlogFilter) ([]*Blog, int64, error)
	Create(ctx context.Context, req *BlogReq) (*Blog, error)
	Update(ctx context.Context, id int64, req *BlogUpdateReq) (*Blog, error)
	...
	GetCategoriesByBlogID(ctx context.Context, blogID int64) ([]*BlogCategory, error)
...
func (r *categoryRepository) GetByID(ctx context.Context, id int64) (*BlogCategory, error) {
...
func (r *categoryRepository) GetAll(ctx context.Context) ([]*BlogCategory, error) {
	query := `SELECT id, name, description, slug, parent_id, created_at, updated_at
...
func (r *categoryRepository) Create(ctx context.Context, req *BlogCategoryReq) (*BlogCategory, error) {
...
func (r *categoryRepository) Update(ctx context.Context, id int64, req *BlogCategoryUpdateReq) (*BlogCategory, error) {
	if !req.ParentID.Set {
...
func updateBlogCategory(ctx context.Context, db blogDB, id int64, req *BlogCategoryUpdateReq) (*BlogCategory, error) {
...
type repository struct{ db blogDB }
...
func scanBlog(row pgx.Row, b *Blog) error {
	return row.Scan(blogScanDest(b)...)
}

func (r *repository) GetByID(ctx context.Context, id int64) (*Blog, error) {
...
func (r *repository) GetBySlug(ctx context.Context, slug string) (*Blog, error) {
...
func (r *repository) Update(ctx context.Context, id int64, req *BlogUpdateReq) (*Blog, error) {
	sets := []string{"updated_at = NOW()"}
	args := pgx.NamedArgs{"id": id}
...
func (r *repository) IncrementReads(ctx context.Context, id int64) error {
	_, err := r.db.Exec(ctx,
...
func (r *repository) AssignCategories(ctx context.Context, blogID int64, categoryIDs []int64) error {
...
func (r *repository) RemoveCategories(ctx context.Context, blogID int64) error {
	_, err := r.db.Exec(ctx, `DELETE FROM blog_categories_assignments WHERE blog_id = $1`, blogID)
	return err
}

func (r *repository) GetCategoriesByBlogID(ctx context.Context, blogID int64) ([]*BlogCategory, error) {
...
func (r *repository) AssignProducts(ctx context.Context, blogID int64, productIDs []int64) error {
	if len(productIDs) == 0 {
		return nil
	}
	batch := &pgx.Batch{}
...
func (r *repository) RemoveProducts(ctx context.Context, blogID int64) error {
	_, err := r.db.Exec(ctx, `DELETE FROM blog_products WHERE blog_id = $1`, blogID)
	return err
}

func (r *repository) GetProductIDsByBlogID(ctx context.Context, blogID int64) ([]int64, error) {
...
func (r *repository) AssignTags(ctx context.Context, blogID int64, tagIDs []int64) error {
	if len(tagIDs) == 0 {
		return nil
	}
	batch := &pgx.Batch{}
...
func (r *repository) RemoveTags(ctx context.Context, blogID int64) error {
	_, err := r.db.Exec(ctx, `DELETE FROM blog_tags WHERE blog_id = $1`, blogID)
	return err
}

func (r *repository) GetTagIDsByBlogID(ctx context.Context, blogID int64) ([]int64, error) {
