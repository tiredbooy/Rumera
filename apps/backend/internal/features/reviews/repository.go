...
type Repository interface {
	Create(ctx context.Context, userID int64, req CreateReviewReq, verifiedPurchase bool) (*Review, error)
	GetByID(ctx context.Context, id int64) (*Review, error)
	GetAll(ctx context.Context, filter ReviewFilter) ([]*Review, int64, error)
	Update(ctx context.Context, id int64, userID int64, req UpdateReviewReq) (*Review, error)
	UpdateStatus(ctx context.Context, id int64, req UpdateReviewStatusReq) (*Review, error)
	...
	GetPending(ctx context.Context, userID int64) ([]PendingReviewResponse, error)
}
...
func (r *repository) Create(ctx context.Context, userID int64, req CreateReviewReq, verifiedPurchase bool) (*Review, error) {
	const q = `
		WITH inserted AS (
	...
	review, err := pgx.CollectOneRow(rows, pgx.RowToStructByNameLax[Review])
	if err != nil {
...
func (r *repository) GetAll(ctx context.Context, f ReviewFilter) ([]*Review, int64, error) {
...
func (r *repository) Update(ctx context.Context, id int64, userID int64, req UpdateReviewReq) (*Review, error) {
...
func (r *repository) UpdateStatus(ctx context.Context, id int64, req UpdateReviewStatusReq) (*Review, error) {
	const q = `
		WITH updated AS (
...
func (r *repository) GetRatingSummary(ctx context.Context, productID int64) (*ProductRatingSummary, error) {
	const q = `
		SELECT
			COUNT(*)                                         AS total,
...
func (r *repository) React(ctx context.Context, id int64, userID int64, like bool) error {
...
func (r *repository) HasPurchased(ctx context.Context, userID int64, productID int64) (bool, error) {
	const q = `
		SELECT EXISTS(
			SELECT 1
			FROM orders o
...
func (r *repository) GetMine(ctx context.Context, userID int64) ([]AccountReviewResponse, error) {
	const q = `
	...
	reviews, err := pgx.CollectRows(rows, pgx.RowToStructByName[AccountReviewResponse])
	if err != nil {
...
func (r *repository) GetPending(ctx context.Context, userID int64) ([]PendingReviewResponse, error) {
	const q = `
	...
	items, err := pgx.CollectRows(rows, pgx.RowToStructByName[PendingReviewResponse])
	if err != nil {
