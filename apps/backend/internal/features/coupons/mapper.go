...
func ToCouponResponse(c *Coupon, totalUses int) CouponResponse {
...
func CalculateDiscount(c *Coupon, orderSubtotal float64) (discountAmount float64, freeShipping bool) {
...
func ValidateCouponBusiness(
	c *Coupon,
	req ValidateCouponReq,
	totalUses int,
	userUses int,
...
func invalid(reason string) CouponValidationResult {
	return CouponValidationResult{IsValid: false, InvalidReason: reason}
}
...
func CouponAppliesToBasket(c *Coupon, req ValidateCouponReq) bool {
