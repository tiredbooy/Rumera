...
type Repository interface {
	Get(ctx context.Context, userID int64) (*TasteProfile, error)
	Upsert(ctx context.Context, userID int64, profile TasteProfile) error
}
...
func (r *tasteProfileRepository) Get(ctx context.Context, userID int64) (*TasteProfile, error) {
...
func (r *tasteProfileRepository) Upsert(ctx context.Context, userID int64, profile TasteProfile) error {
