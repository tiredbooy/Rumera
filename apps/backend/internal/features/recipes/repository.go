...
type Repository interface {
	...
	GetBySlug(ctx context.Context, slug string) (*Recipe, error)
	GetPublishedBySlug(ctx context.Context, slug string) (*Recipe, error)
	List(ctx context.Context, filter RecipeFilter) ([]*Recipe, int64, error)
	Create(ctx context.Context, req *RecipeReq) (*Recipe, error)
	Update(ctx context.Context, id int64, req *RecipeUpdateReq) (*Recipe, error)
	...
	// ingredients
	GetIngredientsByRecipeID(ctx context.Context, recipeID int64) ([]*RecipeIngredient, error)
	CreateIngredient(ctx context.Context, recipeID int64, req *RecipeIngredientReq) (*RecipeIngredient, error)
	CreateIngredients(ctx context.Context, recipeID int64, reqs []*RecipeIngredientReq) ([]*RecipeIngredient, error)
	UpdateIngredient(ctx context.Context, id int64, req *RecipeIngredientReq) (*RecipeIngredient, error)
	...
	GetProductsByRecipeID(ctx context.Context, recipeID int64) ([]*RecipeProduct, error)
	GetShoppableProducts(ctx context.Context, recipeID int64) ([]*ShoppableProduct, error)
	AssignProducts(ctx context.Context, recipeID int64, reqs []*RecipeProductReq) error
	...
	GetRecipeCardsByProductID(ctx context.Context, productID int64, limit int) ([]*Recipe, error)

	// tags
	GetTagsByRecipeID(ctx context.Context, recipeID int64) ([]*RecipeTagInfo, error)
...
// recipeDB is the common subset of *pgxpool.Pool and pgx.Tx used by recipes.
...
type repository struct{ db recipeDB }
...
func recipeScanDest(r *Recipe) []any {
	return []any{
...
func scanRecipe(row pgx.Row, r *Recipe) error {
	return row.Scan(recipeScanDest(r)...)
}

// ── Recipe CRUD ───────────────────────────────────────────────────────────────

func (r *repository) GetByID(ctx context.Context, id int64) (*Recipe, error) {
	rec := &Recipe{}
...
func (r *repository) GetBySlug(ctx context.Context, slug string) (*Recipe, error) {
	rec := &Recipe{}
	err := scanRecipe(r.db.QueryRow(ctx,
...
func (r *repository) Create(ctx context.Context, req *RecipeReq) (*Recipe, error) {
...
func (r *repository) Update(ctx context.Context, id int64, req *RecipeUpdateReq) (*Recipe, error) {
...
func (r *repository) PublishedSitemap(ctx context.Context) ([]*RecipeSitemapItem, error) {
	...
	var items []*RecipeSitemapItem
	for rows.Next() {
		it := &RecipeSitemapItem{}
...
func scanIngredient(row pgx.Row, i *RecipeIngredient) error {
	return row.Scan(
...
func (r *repository) GetIngredientsByRecipeID(ctx context.Context, recipeID int64) ([]*RecipeIngredient, error) {
	rows, err := r.db.Query(ctx,
...
func (r *repository) CreateIngredient(ctx context.Context, recipeID int64, req *RecipeIngredientReq) (*RecipeIngredient, error) {
...
func (r *repository) CreateIngredients(ctx context.Context, recipeID int64, reqs []*RecipeIngredientReq) ([]*RecipeIngredient, error) {
	if len(reqs) == 0 {
		return nil, nil
	}
	...
	ingredients := make([]*RecipeIngredient, 0, len(reqs))
	for range reqs {
		i := &RecipeIngredient{}
...
func (r *repository) UpdateIngredient(ctx context.Context, id int64, req *RecipeIngredientReq) (*RecipeIngredient, error) {
...
func (r *repository) GetProductsByRecipeID(ctx context.Context, recipeID int64) ([]*RecipeProduct, error) {
	rows, err := r.db.Query(ctx,
...
func (r *repository) GetShoppableProducts(ctx context.Context, recipeID int64) ([]*ShoppableProduct, error) {
	const q = `
		SELECT
			rp.id,
...
func (r *repository) AssignProducts(ctx context.Context, recipeID int64, reqs []*RecipeProductReq) error {
	if len(reqs) == 0 {
		return nil
	}
...
func (r *repository) RemoveProducts(ctx context.Context, recipeID int64) error {
	_, err := r.db.Exec(ctx, `DELETE FROM recipe_products WHERE recipe_id = $1`, recipeID)
	return err
}

func (r *repository) GetRecipeCardsByProductID(ctx context.Context, productID int64, limit int) ([]*Recipe, error) {
	if limit <= 0 {
		limit = 8
	}
	const q = `
...
func (r *repository) GetTagsByRecipeID(ctx context.Context, recipeID int64) ([]*RecipeTagInfo, error) {
	rows, err := r.db.Query(ctx,
...
func (r *repository) GetTagIDsByRecipeID(ctx context.Context, recipeID int64) ([]int64, error) {
	rows, err := r.db.Query(ctx,
...
func (r *repository) AssignTags(ctx context.Context, recipeID int64, tagIDs []int64) error {
	if len(tagIDs) == 0 {
		return nil
	}
