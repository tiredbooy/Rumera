...
type Repository interface {
	...
	ForUser(ctx context.Context, profile *UserRecommendationProfile, excludeIDs []int64, q RecommendationQuery) ([]*RecommendationItem, error)
...
func scanCards(rows pgx.Rows) ([]*RecommendationItem, error) {
	defer rows.Close()
...
func (r *repository) ActiveUserIDs(ctx context.Context, sinceDays, limit int) ([]int64, error) {
	if sinceDays <= 0 {
		sinceDays = 30
	}
	if limit <= 0 {
...
func (r *repository) Trending(ctx context.Context, q RecommendationQuery) ([]*RecommendationItem, error) {
...
func (r *repository) Similar(ctx context.Context, productID int64, q RecommendationQuery) ([]*RecommendationItem, error) {
...
func (r *repository) FrequentlyBoughtTogether(ctx context.Context, productID int64, q RecommendationQuery) ([]*RecommendationItem, error) {
	args := pgx.NamedArgs{"pid": productID, "limit": q.Limit}
...
func (r *repository) ForUser(ctx context.Context, profile *UserRecommendationProfile, excludeIDs []int64, q RecommendationQuery) ([]*RecommendationItem, error) {
...
func (r *repository) GetProfile(ctx context.Context, userID int64) (*UserRecommendationProfile, error) {
	var (
		p         = &UserRecommendationProfile{UserID: userID}
		catsRaw   []byte
		brandsRaw []byte
		tagsRaw   []byte
	)
...
func (r *repository) ComputeProfile(ctx context.Context, userID int64) (*UserRecommendationProfile, error) {
...
func (r *repository) affinityByCategory(ctx context.Context, userID int64) ([]AffinityScore, error) {
...
func (r *repository) affinityByBrand(ctx context.Context, userID int64) ([]AffinityScore, error) {
	const q = userSignalsCTE + `
...
func (r *repository) affinityByTag(ctx context.Context, userID int64) ([]AffinityScore, error) {
	const q = userSignalsCTE + `
...
func (r *repository) scanAffinity(ctx context.Context, query string, userID int64) ([]AffinityScore, error) {
...
func (r *repository) OpsStats(ctx context.Context, windowDays int) (*RecommendationOpsStats, error) {
	if windowDays <= 0 {
		windowDays = 30
	}
	if windowDays > 365 {
