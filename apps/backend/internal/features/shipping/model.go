...
type UpdateShippingZoneReq struct {
	Name        models.NullablePatch[string]   `json:"name"`
	Description models.NullablePatch[string]   `json:"description"`
	RegionCodes models.NullablePatch[[]string] `json:"region_codes"`
...
type UpdateShippingMethodReq struct {
	Name            models.NullablePatch[string]           `json:"name"`
	Carrier         models.NullablePatch[string]           `json:"carrier"`
	Description     models.NullablePatch[string]           `json:"description"`
	RateType        models.NullablePatch[ShippingRateType] `json:"rate_type"`
	BaseRate        models.NullablePatch[float64]          `json:"base_rate"`
	FreeAboveAmount models.NullablePatch[float64]          `json:"free_above_amount"`
	MinDeliveryDays models.NullablePatch[int16]            `json:"min_delivery_days"`
	MaxDeliveryDays models.NullablePatch[int16]            `json:"max_delivery_days"`
	MaxWeightKg     models.NullablePatch[float64]          `json:"max_weight_kg"`
	IsActive        models.NullablePatch[bool]             `json:"is_active"`
}
