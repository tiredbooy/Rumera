...
type AdminCreateUserReq struct {
	...
	BirthDate    *time.Time `json:"birth_date"`
	Gender       *string    `json:"gender"        validate:"omitempty,oneof=male female other"`
	Role         *string    `json:"role"          validate:"omitempty,oneof=customer vendor admin staff"`
...
type AdminUpdateUserReq struct {
	FirstName    models.NullablePatch[string]    `json:"first_name"`
	LastName     models.NullablePatch[string]    `json:"last_name"`
	Phone        models.NullablePatch[string]    `json:"phone"`
	NationalCode models.NullablePatch[string]    `json:"national_code"`
	BirthDate    models.NullablePatch[time.Time] `json:"birth_date"`
	Gender       models.NullablePatch[string]    `json:"gender"`
	Role         models.NullablePatch[string]    `json:"role"`
...
type UserFilter struct {
	models.BaseFilter // Page, Limit, Offset(), SortBy, OrderBy, Search

	// user-specific
	Role        *string    `query:"role"         validate:"omitempty,oneof=customer admin vendor staff"`
