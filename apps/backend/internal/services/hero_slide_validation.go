...
func normalizeAndValidateHeroSlideCreate(req *models.HeroSlideReq) error {
	...
	validateHeroSlideState(&models.HeroSlide{
		Eyebrow:           req.Eyebrow,
		Title:             req.Title,
...
func validateHeroSlideState(slide *models.HeroSlide, fields map[string][]string) {
