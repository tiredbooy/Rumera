...
func TestMediaStorageKeyRejectsInvalidContracts(t *testing.T) {
	tests := []struct {
		...
		{name: "unknown owner", kind: "unknown", id: 1, role: MediaRoleCover, uid: testMediaObjectID, ext: "webp"},
		{name: "non-positive id", kind: MediaOwnerRecipe, id: 0, role: MediaRoleCover, uid: testMediaObjectID, ext: "webp"},
		{name: "wrong role", kind: MediaOwnerHeroSlide, id: 1, role: MediaRoleCover, uid: testMediaObjectID, ext: "webp"},
		{name: "invalid uuid", kind: MediaOwnerRecipe, id: 1, role: MediaRoleCover, uid: "../escape", ext: "webp"},
		{name: "invalid extension", kind: MediaOwnerRecipe, id: 1, role: MediaRoleCover, uid: testMediaObjectID, ext: "svg"},
	}
...
func TestContentMediaSlotUsesClosedOwnerRoleMatrix(t *testing.T) {
	valid := []struct {
		...
		{ownerType: "hero-slides", role: "desktop", kind: MediaOwnerHeroSlide, mediaRole: MediaRoleDesktop},
		{ownerType: "hero-slides", role: "mobile", kind: MediaOwnerHeroSlide, mediaRole: MediaRoleMobile},
		{ownerType: "recipes", role: "cover", kind: MediaOwnerRecipe, mediaRole: MediaRoleCover},
		{ownerType: "recipes", role: "og", kind: MediaOwnerRecipe, mediaRole: MediaRoleOG},
		{ownerType: "journal", role: "cover", kind: MediaOwnerJournal, mediaRole: MediaRoleCover},
	}
