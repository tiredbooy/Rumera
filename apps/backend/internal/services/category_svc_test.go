...
type categoryServiceRepo struct {
	...
	nameExists bool
	slugExists bool
	created    *models.CreateCategoryReq
}

func (r *categoryServiceRepo) GetBySlug(_ context.Context, slug string) (*models.Category, error) {
	r.calls++
	r.gotSlug = slug
	if r.slugErr != nil {
...
func (r *categoryServiceRepo) Create(_ context.Context, req models.CreateCategoryReq) (*models.Category, error) {
	r.created = &req
	return r.category, nil
}
