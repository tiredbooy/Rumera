...
type SearchSummaryRepository interface {
	Upsert(ctx context.Context, req *models.SearchSummaryUpsertReq) error
	UpsertBatch(ctx context.Context, reqs []*models.SearchSummaryUpsertReq) error
	GetByDateAndQuery(ctx context.Context, date time.Time, queryText string) (*models.SearchSummary, error)
	GetRange(ctx context.Context, filter models.SearchSummaryFilter) ([]*models.SearchSummary, error)

	// Aggregated views for dashboards
	TopSearchTerms(ctx context.Context, dateFrom, dateTo time.Time, limit int) ([]*models.SearchTermSummary, error)
	ZeroResultTerms(ctx context.Context, dateFrom, dateTo time.Time, limit int) ([]*models.SearchTermSummary, error)
	TopConvertingTerms(ctx context.Context, dateFrom, dateTo time.Time, limit int) ([]*models.SearchTermSummary, error)
}
...
func searchUpsertArgs(req *models.SearchSummaryUpsertReq) ([]any, error) {
...
func (r *searchSummaryRepository) Upsert(ctx context.Context, req *models.SearchSummaryUpsertReq) error {
...
func (r *searchSummaryRepository) UpsertBatch(ctx context.Context, reqs []*models.SearchSummaryUpsertReq) error {
	if len(reqs) == 0 {
		return nil
	}
...
func (r *searchSummaryRepository) GetByDateAndQuery(ctx context.Context, date time.Time, queryText string) (*models.SearchSummary, error) {
	query := `
...
func (r *searchSummaryRepository) GetRange(ctx context.Context, filter models.SearchSummaryFilter) ([]*models.SearchSummary, error) {
	query := `
		SELECT date, query_text,
		       search_count, unique_users, unique_sessions,
		       avg_results_count, zero_results_count,
...
func (r *searchSummaryRepository) TopSearchTerms(ctx context.Context, dateFrom, dateTo time.Time, limit int) ([]*models.SearchTermSummary, error) {
	return r.aggregateTerms(ctx, dateFrom, dateTo, limit, "SUM(search_count)", false)
}

func (r *searchSummaryRepository) ZeroResultTerms(ctx context.Context, dateFrom, dateTo time.Time, limit int) ([]*models.SearchTermSummary, error) {
	return r.aggregateTerms(ctx, dateFrom, dateTo, limit, "SUM(zero_results_count)", true)
}

func (r *searchSummaryRepository) TopConvertingTerms(ctx context.Context, dateFrom, dateTo time.Time, limit int) ([]*models.SearchTermSummary, error) {
...
) ([]*models.SearchTermSummary, error) {
	query := fmt.Sprintf(`
		SELECT
			query_text,
...
func scanSearchSummary(row pgx.Row) (*models.SearchSummary, error) {
	s := &models.SearchSummary{}
