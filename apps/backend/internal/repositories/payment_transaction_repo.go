...
type PaymentTransactionRepository interface {
	Create(ctx context.Context, tx pgx.Tx, req models.CreatePaymentTransactionReq) (*models.PaymentTransaction, error)
	GetByID(ctx context.Context, id int64) (*models.PaymentTransaction, error)
	GetByTransactionID(ctx context.Context, transactionID string) (*models.PaymentTransaction, error)
	GetAll(ctx context.Context, filter models.PaymentTransactionFilter) ([]*models.PaymentTransaction, int64, error)
	Confirm(ctx context.Context, tx pgx.Tx, req models.ConfirmPaymentReq) (*models.PaymentTransaction, error)
	Fail(ctx context.Context, req models.FailPaymentReq) (*models.PaymentTransaction, error)
...
func (r *paymentTransactionRepository) Create(ctx context.Context, tx pgx.Tx, req models.CreatePaymentTransactionReq) (*models.PaymentTransaction, error) {
	const q = `
	...
	pt, err := pgx.CollectOneRow(rows, pgx.RowToStructByName[models.PaymentTransaction])
	if err != nil {
...
func (r *paymentTransactionRepository) GetByID(ctx context.Context, id int64) (*models.PaymentTransaction, error) {
...
func (r *paymentTransactionRepository) GetByTransactionID(ctx context.Context, transactionID string) (*models.PaymentTransaction, error) {
...
func (r *paymentTransactionRepository) GetAll(ctx context.Context, f models.PaymentTransactionFilter) ([]*models.PaymentTransaction, int64, error) {
	where := []string{"1=1"}
	args := pgx.NamedArgs{}
...
func (r *paymentTransactionRepository) Confirm(ctx context.Context, tx pgx.Tx, req models.ConfirmPaymentReq) (*models.PaymentTransaction, error) {
	const q = `
...
func (r *paymentTransactionRepository) Fail(ctx context.Context, req models.FailPaymentReq) (*models.PaymentTransaction, error) {
	const q = `
		UPDATE payment_transactions
		SET status        = 'failed',
