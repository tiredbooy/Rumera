...
func (r *subscriptionRepository) Create(ctx context.Context, sub models.Subscription) (*models.Subscription, error) {
	const q = `
	...
	s, err := pgx.CollectOneRow(rows, pgx.RowToStructByName[models.Subscription])
	if err != nil {
...
func (r *subscriptionRepository) ListByUser(ctx context.Context, userID int64) ([]models.Subscription, error) {
...
func (r *subscriptionRepository) Get(ctx context.Context, id, userID int64) (*models.Subscription, error) {
...
func (r *subscriptionRepository) FindDue(ctx context.Context, now time.Time, limit int) ([]models.DueSubscription, error) {
	const q = `
	...
	due, err := pgx.CollectRows(rows, pgx.RowToStructByName[models.DueSubscription])
	if err != nil {
