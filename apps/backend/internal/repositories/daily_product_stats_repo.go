...
type DailyProductStatsRepository interface {
	...
	Upsert(ctx context.Context, req *models.DailyProductStatsUpsertReq) error
	...
	SummaryByProduct(ctx context.Context, filter models.ProductStatsFilter) (*models.ProductStatsSummary, error)

	// TopProducts — leaderboard by revenue or views for a date range
	TopProductsByRevenue(ctx context.Context, dateFrom, dateTo time.Time, limit int) ([]*models.TopProductEntry, error)
	TopProductsByViews(ctx context.Context, dateFrom, dateTo time.Time, limit int) ([]*models.TopProductEntry, error)
}
...
func upsertArgs(req *models.DailyProductStatsUpsertReq) []any {
	return []any{
...
func (r *dailyProductStatsRepository) Upsert(ctx context.Context, req *models.DailyProductStatsUpsertReq) error {
...
func (r *dailyProductStatsRepository) UpsertBatch(ctx context.Context, reqs []*models.DailyProductStatsUpsertReq) error {
	if len(reqs) == 0 {
		return nil
	}
...
func scanStats(row pgx.Row, s *models.DailyProductStats) error {
	return row.Scan(
		&s.Date, &s.ProductID,
...
func (r *dailyProductStatsRepository) SummaryByProduct(ctx context.Context, filter models.ProductStatsFilter) (*models.ProductStatsSummary, error) {
	query := `
		SELECT
			product_id,
...
func (r *dailyProductStatsRepository) TopProductsByRevenue(ctx context.Context, dateFrom, dateTo time.Time, limit int) ([]*models.TopProductEntry, error) {
	return r.topProducts(ctx, "revenue_total", dateFrom, dateTo, limit)
}

func (r *dailyProductStatsRepository) TopProductsByViews(ctx context.Context, dateFrom, dateTo time.Time, limit int) ([]*models.TopProductEntry, error) {
	return r.topProducts(ctx, "views_total", dateFrom, dateTo, limit)
}

func (r *dailyProductStatsRepository) topProducts(ctx context.Context, orderBy string, dateFrom, dateTo time.Time, limit int) ([]*models.TopProductEntry, error) {
	query := fmt.Sprintf(`
		SELECT
			product_id,
			SUM(revenue_total) AS total_revenue,
