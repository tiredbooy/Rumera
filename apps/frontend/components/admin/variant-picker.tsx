      ...
      >
        {step === "product" ? (
          <div className="flex flex-col">
            ...
            <div className="no-scrollbar max-h-64 overflow-y-auto p-1.5" role="listbox" aria-label="محصولات">
          ...
          <div className="flex flex-col">
            ...
            <div className="no-scrollbar max-h-64 overflow-y-auto p-1.5" role="listbox" aria-label="تنوع‌ها">
