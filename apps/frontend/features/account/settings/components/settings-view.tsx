  ...
  function onSubmit(values: ProfileValues) {
    ...
    update.mutate(
      input,
      {
        ...
        onError: () =>
          toast.error("به‌روزرسانی پروفایل ناموفق بود. دوباره تلاش کنید."),
      },
    );
  }
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="grid gap-5">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="flex flex-col gap-2">
            ...
            >
              <Mail className="size-3" aria-hidden /> برای تغییر ایمیل با
        ...
        <ComingSoonRow
          ...
          control={
            <Switch
              checked={false}
              disabled
              aria-label="ورود دومرحله‌ای (به‌زودی)"
            />
          }
        />
      </AccountSection>
...
const NOTIFY_OPTIONS = [
  {
    key: "order_email",
    label: "ایمیل وضعیت سفارش",
    desc: "به‌روزرسانی پرداخت و ارسال",
  },
  { key: "order_sms", label: "پیامک وضعیت سفارش", desc: "اطلاع لحظه‌ای تحویل" },
  {
    key: "promo_email",
    label: "ایمیل پیشنهادها",
    desc: "تخفیف‌ها و محصولات تازه",
  },
  {
    key: "loyalty",
    label: "اعلان باشگاه مشتریان",
    desc: "امتیاز و پاداش‌های جدید",
  },
];
        ...
        <div className="flex items-center justify-between gap-4">
          <div className="min-w-0">
            ...
            <p className="mt-0.5 text-sm text-muted-foreground">
              حذف خودکار حساب هنوز فعال نیست. برای حذف حساب، فعلاً با پشتیبانی
              تماس بگیرید.
            </p>
          </div>
          <Button
