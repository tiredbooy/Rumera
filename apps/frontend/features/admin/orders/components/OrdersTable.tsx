...
const STATUS_FILTER_OPTIONS = (Object.keys(ORDER_STATUS_FA) as OrderStatus[]).map((s) => ({
  value: s,
  ...
  const columns: Column<OrderListItem>[] = [
    {
      ...
      header: "شماره",
      sortValue: (o) => o.id,
      cell: (o) => <span className="font-medium" dir="ltr">#{faNum(o.id)}</span>,
    },
    {
      id: "date",
      header: "تاریخ",
    ...
    },
    {
      ...
      cell: (o) => <span className="font-medium">{formatPrice(o.total_amount)}</span>,
    },
    {
      id: "payment",
      header: "روش پرداخت",
      sortValue: (o) => o.payment_method,
      cell: (o) => <span className="text-muted-foreground">{PAYMENT_FA[o.payment_method]}</span>,
    },
    {
      id: "status",
      header: "وضعیت",
