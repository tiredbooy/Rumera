        ...
        <div className="container-px mx-auto grid max-w-7xl items-center gap-12 py-16 lg:grid-cols-2 lg:py-24">
          <Reveal>
            ...
            <p className="mt-6 max-w-md text-lg text-muted-foreground">
              رومرا با یک باور ساده ساخته شد: خریدِ چیزهای خوب باید آسان، مطمئن
              و لذت‌بخش باشد. ما بهترین‌ها را از برندهای معتبر گرد هم می‌آوریم
              تا شما با خیال راحت انتخاب کنید.
            </p>
      ...
      <section className="container-px mx-auto grid max-w-7xl items-center gap-12 py-20 lg:grid-cols-2">
        ...
        <Reveal delay={0.1}>
          ...
          <p className="mt-5 text-muted-foreground">
            ما واسطه‌های اضافی را حذف کردیم تا کیفیت بالا با قیمتی منصفانه به
            دست شما برسد. هر برند پیش از راه‌یافتن به فروشگاه ارزیابی می‌شود و
            هر تجربهٔ خرید برای ما اهمیت دارد.
          </p>
            ...
            {timeline.map((item, i) => (
              <Reveal key={item.year} delay={Math.min(i, 4) * 0.06} y={16}>
                <li className="relative">
                  ...
                  />
                  <span className="font-serif text-2xl text-foil">
                    {item.year}
                  </span>
          ...
          {steps.map((s, i) => (
            <Reveal key={s.title} delay={i * 0.07} y={16}>
              <div className="hover-lift border-hairline group/step relative h-full rounded-3xl bg-card p-7">
                <span className="font-serif text-5xl text-foil/30">
                  {faNum(i + 1)}
                </span>
