    ...
    items: [
      {
        ...
        answer:
          "سفارش با بسته‌بندی ایمن ارسال می‌شود تا کالا سالم به دست شما برسد. زمان و هزینهٔ ارسال هنگام تسویه محاسبه و نمایش داده می‌شود.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        answer:
          "در صورت آسیب‌دیدگی یا مغایرت، کالا با هماهنگی پشتیبانی قابل بازگشت یا تعویض است. صفحهٔ جداگانه‌ای برای بازگشت وجود ندارد؛ از صفحهٔ تماس با ما پیام بگذارید.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        answer:
          "برای افزودن کالا به سبد و تکمیل خرید باید وارد حساب شوید. با حساب می‌توانید سفارش‌ها را پیگیری کنید، آدرس‌ها را ذخیره کنید و از امکانات باشگاه مشتریان استفاده کنید.",
      },
    ],
  },
];
