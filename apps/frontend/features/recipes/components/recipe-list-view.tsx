...
export type RecipeListSearchParams = Promise<{
  q?: string;
  difficulty?: string;
  sort?: string;
  page?: string;
...
function toParams(sp: Awaited<RecipeListSearchParams>): RecipeListQuery {
...
function pageHref(sp: Awaited<RecipeListSearchParams>, page: number): string {
...
export async function RecipeListView({ searchParams }: RecipeListViewProps) {
